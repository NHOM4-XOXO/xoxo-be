...
public interface UserGraphRepository extends Neo4jRepository<UserNode, Long> {
    ...
    @Query("""
            ...
            RETURN fof.id AS id, fof.username AS username, mutualFriendsCount AS mutualFriendsCount
            LIMIT 50
            """)
    List<SuggestedFriendProjection> suggestFriendsViaMutuals(@Param("userId") Long userId);
}