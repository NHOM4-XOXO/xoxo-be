...
public class MessengerController {
    ...
    // Helper method for WebSocket context
    ...
    public ResponseEntity<WrapRes<Void>> markAsDelivered(@PathVariable String messageId) {
        ...
        if (currentUser == null) {
            return ResponseEntity.status(401).body(WrapRes.error("User not found"));
        }
        messengerChatService.markMessageAsDelivered(messageId, currentUser.getId());
    ...
    public ResponseEntity<WrapRes<Void>> markAsRead(@PathVariable String messageId) {
        ...
        messengerChatService.markMessageAsRead(messageId, currentUser.getId());
        return ResponseEntity.ok(WrapRes.success(null));
    }
    ...
    public ResponseEntity<WrapRes<Void>> markConversationAsRead(@PathVariable Long chatRoomId) {
        ...
        messengerChatService.markConversationAsRead(chatRoomId, currentUser.getId());
        return ResponseEntity.ok(WrapRes.success(null));
    }
    ...
    public ResponseEntity<WrapRes<Void>> addReaction(
        ...
        messengerChatService.addReaction(messageId, currentUser.getId(), reaction);
        return ResponseEntity.ok(WrapRes.success(null));
    }
    ...
    public ResponseEntity<WrapRes<Void>> removeReaction(@PathVariable String messageId) {
        ...
        messengerChatService.removeReaction(messageId, currentUser.getId());
        return ResponseEntity.ok(WrapRes.success(null));
    }
    ...
    public void startTyping(@Payload TypingIndicatorRequest request, Principal principal) {
        try {
            User user = getCurrentUserFromPrincipal(principal);
            if (user != null) {
                messengerChatService.startTyping(request.getChatRoomId(), user.getId());
            } else {
                log.warn("User not found for email: {}", principal != null ? principal.getName() : "null");
            }
        } catch (Exception e) {
            log.error("Error in startTyping for user: {}", principal != null ? principal.getName() : "null", e);
        }
    }
    ...
    public void stopTyping(@Payload TypingIndicatorRequest request, Principal principal) {
        try {
            User user = getCurrentUserFromPrincipal(principal);
            if (user != null) {
                messengerChatService.stopTyping(request.getChatRoomId(), user.getId());
            } else {
                log.warn("User not found for email: {}", principal != null ? principal.getName() : "null");
            }
        } catch (Exception e) {
            log.error("Error in stopTyping for user: {}", principal != null ? principal.getName() : "null", e);
        }
    }
    ...
    public ResponseEntity<WrapRes<Page<ChatMessageResponse>>> searchGlobalMessages(
        ...
        Pageable pageable = PageRequest.of(page, size);
        Page<ChatMessageResponse> results = messengerChatService.searchGlobalMessages(currentUser.getId(), query, pageable);
        return ResponseEntity.ok(WrapRes.success(results));
    }
    ...
    public ResponseEntity<WrapRes<ChatMessageResponse>> editMessage(
        ...
        ChatMessageResponse response = messengerChatService.editMessage(messageId, content, currentUser.getId());
        return ResponseEntity.ok(WrapRes.success(response));
    }
    ...
    public ResponseEntity<WrapRes<Void>> deleteMessage(@PathVariable String messageId) {
        ...
        messengerChatService.deleteMessage(messageId, currentUser.getId());
        return ResponseEntity.ok(WrapRes.success(null));
    }
    ...
    public ResponseEntity<WrapRes<Void>> pinMessage(@PathVariable String messageId) {
        ...
        messengerChatService.pinMessage(messageId, currentUser.getId());
        return ResponseEntity.ok(WrapRes.success(null));
    }
    ...
    public ResponseEntity<WrapRes<Void>> unpinMessage(@PathVariable String messageId) {
        ...
        messengerChatService.unpinMessage(messageId, currentUser.getId());
        return ResponseEntity.ok(WrapRes.success(null));
    }
    ...
    public ResponseEntity<WrapRes<Map<String, Integer>>> getUnreadMessageCount() {
        ...
        int count = messengerChatService.getUnreadMessageCount(currentUser.getId());
    ...
    public ResponseEntity<WrapRes<Map<String, Integer>>> getUnreadMessageCountForRoom(@PathVariable Long chatRoomId) {
        ...
        int count = messengerChatService.getUnreadMessageCountForRoom(chatRoomId, currentUser.getId());
        return ResponseEntity.ok(WrapRes.success(Map.of("unreadCount", count)));
    }
    ...
    public ResponseEntity<WrapRes<Void>> markMultipleAsRead(@RequestBody List<String> messageIds) {
        ...
        messengerChatService.markMultipleMessagesAsRead(messageIds, currentUser.getId());
        return ResponseEntity.ok(WrapRes.success(null));
    }
    ...
    public ResponseEntity<WrapRes<Void>> deleteMultipleMessages(@RequestBody List<String> messageIds) {
        ...
        messengerChatService.deleteMultipleMessages(messageIds, currentUser.getId());
        return ResponseEntity.ok(WrapRes.success(null));
    }
}